...
_DEFAULT_LISTINO = json.dumps(
    {
        "stagioni": [
            {"nome": "Bassa", "da": "01/04", "a": "14/06"},
            {"nome": "Media", "da": "15/06", "a": "14/07"},
            {"nome": "Alta", "da": "15/07", "a": "31/08"},
        ],
        "voci": [
            {"nome": "Tenda piccola (max 4m)", "bassa": 8.0, "media": 10.0, "alta": 14.0},
            {"nome": "Tenda grande (oltre 4m)", "bassa": 10.0, "media": 13.0, "alta": 17.0},
            {"nome": "Camper / Caravan", "bassa": 11.0, "media": 14.0, "alta": 18.0},
            {"nome": "Adulto", "bassa": 7.0, "media": 8.5, "alta": 10.0},
            {"nome": "Bambino (3-12 anni)", "bassa": 4.0, "media": 5.0, "alta": 6.0},
            {"nome": "Elettricità (al giorno)", "bassa": 4.0, "media": 4.0, "alta": 5.0},
            {"nome": "Cane", "bassa": 3.0, "media": 3.0, "alta": 4.0},
            {"nome": "Frigorifero (al giorno)", "bassa": 3.5, "media": 3.5, "alta": 4.0},
            {"nome": "Bungalow 2 persone", "bassa": 45.0, "media": 55.0, "alta": 70.0},
            {"nome": "Bungalow 4 persone", "bassa": 65.0, "media": 80.0, "alta": 100.0},
        ],
    },
    ensure_ascii=False,
)
