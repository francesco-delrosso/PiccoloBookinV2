  ...
  <Teleport to="body">
    ...
    >
      <div class="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4">
        <!-- Header -->
        <div class="px-6 py-4 border-b border-border rounded-t-xl bg-green-50">
          <h3 class="text-lg font-semibold text-green-800">Accetta prenotazione</h3>
        </div>
        ...
        <div class="px-6 py-4 border-t border-border flex justify-end gap-3">
          ...
          >
            {{ sending ? 'Invio...' : 'Invia accettazione' }}
          </button>
        </div>
      </div>
    </div>
