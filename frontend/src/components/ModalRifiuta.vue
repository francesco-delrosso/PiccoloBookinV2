  ...
  <Teleport to="body">
    ...
    >
      <div class="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4">
        <!-- Header -->
        <div class="px-6 py-4 border-b border-border rounded-t-xl bg-red-50">
          <h3 class="text-lg font-semibold text-red-800">Rifiuta prenotazione</h3>
        </div>
...
const selectedModello = computed(() =>
  modelli.value.find((m) => m.lingua === lingua.value && m.tipo === 'rifiuta')
)
